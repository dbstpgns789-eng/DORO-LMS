    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email",
                    models.EmailField(
                        max_length=50, unique=True, verbose_name="아이디(이메일)"
                    ),
                ),
                (
                    "role",
                ...
                (
                    ...
                    models.UUIDField(
                        default=uuid.uuid4, verbose_name="이메일 인증 토큰"
                    ),
                ),
                (
                    "groups",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tested_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="테스트 일시"),
                ),
                (
                    "student",
                    models.ForeignKey(
