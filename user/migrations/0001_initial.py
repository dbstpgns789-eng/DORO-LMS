    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, default='010-0000-0000', max_length=15, unique=True, verbose_name='전화번호')),
                ('address', models.CharField(blank=True, max_length=100, null=True, verbose_name='주소')),
                ('birthday', models.DateTimeField(blank=True, verbose_name='생년월일')),
